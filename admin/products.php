            ...
            <table class="table">
               ...
               ?>
                    <tr>
                        ...
                        <td><img style="height: 60px;" src="../uploaded_img/<?= $fetch_products['image']; ?>" alt="">
                        </td>
                        ...
                        <td>
                            <a href="update_product.php?update=<?= $fetch_products['id']; ?>"><button><i
                                        class="fa-solid fa-pen-to-square"></i></button></a>
                            <a href="products.php?delete=<?= $fetch_products['id']; ?>"
                                onclick="return confirm('delete this product?');"><button><i
