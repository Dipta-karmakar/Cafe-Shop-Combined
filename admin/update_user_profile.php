...
if (isset($_POST['submit'])) {
    ...
    if (!empty($_FILES['profile_image']['name'])) {
        ...
        if (in_array(strtolower($ext), $allowed_ext)) {
            ...
            if (!empty($fetch_profile['profile_image']) && file_exists("../uploaded_img/".$fetch_profile['profile_image'])) {
                unlink("../uploaded_img/".$fetch_profile['profile_image']);
            }

            $profile_image_to_save = $new_image_name;
        } else {
            $message[] = 'Invalid image format! Allowed: jpg, jpeg, png, gif.';
            $profile_image_to_save = $fetch_profile['profile_image'];
        }
    } else {
        $profile_image_to_save = $fetch_profile['profile_image'];
    }
